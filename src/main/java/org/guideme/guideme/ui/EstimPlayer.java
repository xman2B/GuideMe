...
public class EstimPlayer  implements Runnable {
	...
	public EstimPlayer(String audioFile, int startAt, int stopAt, int loops, String target, MainShell mainShell, String jscript, String scriptVar) {
